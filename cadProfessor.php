...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Cadastro de Professores</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

	<script src="./scripts/jquery.min.js"></script>
	<script src="./scripts/MaskaraJquery/jquery.mask.js"></script>
	<script src="./scripts/cadastroProfessor.js"></script>
...
<body>
	...
	<section id="container">
		<form action="javascript: void(0)" name="formCad" id="formCad">
			...
			<div id="btnCad">
				<input type="submit" value="Cadastrar Professor" onclick="executaCadastro()">
			</div>
