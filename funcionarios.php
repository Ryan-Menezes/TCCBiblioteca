...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Funcionários</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript" src="./scripts/controleFuncionario.js"></script>
...
<body>
	...
	<nav id="menu2">
		...
		<ul>
			...
			<a href='funcionarios.php'><li id='MarcadoItem'><i class='fas fa-user-circle'></i> Funcionários</li></a>
	...
	<a href="ajuda.php#Funcionario"><div id="btnhelp" title="Ajuda"><i class="fas fa-question"></i></div></a>
		...
		<section class="telas" style="height: 230px;">
			...
			<section class="selectI">
				<form action="javascript: void(0)">
					...
					<div>
						<input type="submit" value="Deletar Funcionário" onclick="excluirFuncionario()">
					<div>
	...
	<section id="principal">
		...
		<div class="ferramentas">
			...
			<div><input type="text" placeholder="Pesquisar funcionário..." id="pesquisaInput" onchange="pesquisaFuncionario()"><button><i class='fas fa-search'></i></button></div>

			<main>
				<button id="relatorio" onclick="abreMoldalRelatorio()">Emitir Relatório <i class='fas fa-file'></i></button>
				<a href="cadFuncionario.php"><button id="cadastro">Cadastrar Funcionário <i class='fas fa-user'></i></button></a>
