...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Alocações</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript" src="./scripts/controleAlocacao.js"></script>
...
<body>
			...
			<section class="selectI">
				<form action="javascript: void(0)">
					<fieldset><legend>Pesquisa</legend>
						<select id="pesqOP">
							<option value="TI" selected>Titulo do livro</option>
							<option value="TO">Tombo do livro</option>						
						</select>
					</fieldset>


					<fieldset><legend>Situação</legend>
						<select id="situacaoOP">
	...
	<nav id="menu2">
		...
		<ul>
			...
			<a href='alocacoes.php'><li id='MarcadoItem'><i class='fas fa-location-arrow'></i> Alocações</li></a>
	...
	<a href="ajuda.php#Alocacoes"><div id="btnhelp" title="Ajuda"><i class="fas fa-question"></i></div></a>
		...
		<section class="telas" style="height: 230px;">
			...
			<section class="selectI">
				<form action="javascript: void(0)">
					...
					<div>
						<input type="submit" value="Desalocar livro" onclick="excluirAlocacao()">
					<div>
	...
	<section id="principal">
		...
		<div class="ferramentas">
			...
			<div><input type="text" placeholder="Pesquisar alocação..." id="pesquisaInput" onchange="pesquisaAlocacao()"><button><i class='fas fa-search'></i></button></div>

			<main>
				<button id="relatorio" onclick="abreMoldalRelatorio()">Emitir Relatório <i class='fas fa-file'></i></button>
				<a href="cadAlocacao.php"><button id="cadastro">Alocar Livros <i class='fas fa-book'></i></button></a>
