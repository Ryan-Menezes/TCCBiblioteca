...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Minha Lista</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript" src="./scripts/minhaLista.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="./css/minhaLista.css">
</head>
<body>
			...
			<?php
				...
				if($nivelAcesso == "A"){
					echo "<a href='Inicio.php'><li><i class='fas fa-home'></i> Inicio</li></a>
						  ...
						  <a href='minhalista.php'><li id='MarcadoItem'><i class='fas fa-list'></i> Minha Lista</li></a>
	...
	<a href="ajuda.php#MinhaLista"><div id="btnhelp" title="Ajuda"><i class="fas fa-question"></i></div></a>
