...
alter table endereco_professor add rm_professor_endereco int not null;
alter table endereco_professor add foreign key(rm_professor_endereco) references professor(rm_professor)
on delete cascade on update cascade;
