...
{
    public partial class F_RelatorioProfessor : Form
    {
        string codigoUsers = string.Empty;

        public F_RelatorioProfessor(List<string> linhas)
        {
            InitializeComponent();
            ...
            for (int l = 0; l < dt.Rows.Count; l++)
            {
                ...
                dgv_relatorio.Rows.Add(System.Drawing.Image.FromStream(ms), rm, nome, cpf, sexo, dataCadastro, status, telefone, celular, email, cep, logradouro, numero, bairro, cidade, complemento, institucoes);
            }
