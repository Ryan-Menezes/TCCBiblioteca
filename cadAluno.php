...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Cadastro de Alunos</title>
	<meta charset="utf-8">
...
<body>
	...
	<section class="MoldalOpcoes">
		...
		<section class="telas">
			...
			<section>
				...
				<footer>
					<div><button class="carregarMaisT" onclick="carregaMaisCurso(this)" title="Carregar Mais"><i class='fas fa-plus'></i></button></div>
				</footer>
			</section>
		</section>
	</section>
	...
	<section id="container">
		<form action="javascript: void(0)" name="formCad" id="formCad">
			...
			<div class="inputs" id="input2">
				...
				<div>
					<div class="inputComBTN">
						<select class="inputV" size="5" id="cursosSelecionados"></select>
				...
				<div class="divide">
					...
					<div>
						<div class="inputFlexContainer">
							<input type="number" name="rm" placeholder="RM" max="999999999" class="inputV">
						</div>
			...
			<div id="btnCad">
				<input type="submit" value="Cadastrar Aluno" onclick="executaCadastro()">
			</div>
