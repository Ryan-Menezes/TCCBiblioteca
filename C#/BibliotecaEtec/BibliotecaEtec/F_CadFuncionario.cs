...
namespace BibliotecaEtec
{
    public partial class F_CadFuncionario : Form
    {
        ...
        {
            F_SelecionaInstituicao f = new F_SelecionaInstituicao(null, this, null, null);
            f.ShowDialog();
        }
            ...
            if (verificaCampos())
            {
                ...
                if (tamanho <= 1048576)
                {
                    ...
                    if (imagemPerfil.Length > 0)
                    {
                        ...
                        funcionario.imgFuncionario = img;
                    }
                    else
                    {
                    ...
                    funcionario.nome = tb_nome.Text.Trim();
                    funcionario.sobrenome = tb_sobrenome.Text.Trim();
                    funcionario.cpf = tb_cpf.Text.Trim();
                    funcionario.sexo = cb_sexo.SelectedValue.ToString();
                    funcionario.cep = tb_cep.Text.Trim();
                    funcionario.logradouro = tb_logradouro.Text.Trim();
                    funcionario.bairro = tb_bairro.Text.Trim();
                    funcionario.numero = tb_numero.Value.ToString();
                    funcionario.cidade = tb_cidade.Text.Trim();
                    funcionario.complemento = tb_complemento.Text.Trim();
                    funcionario.telefone = tb_telefone.Text.Trim();
                    funcionario.celular = tb_celular.Text.Trim();
                    funcionario.email = tb_email.Text.Trim();
                    funcionario.instituicoes = cod_instituicoes;
