...
<html lang="pt-br">
<head>
	<title><?php echo Info::$nomeSistema ?> - Professores</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript" src="./scripts/controleProfessor.js"></script>
...
<body>
	...
	<nav id="menu2">
		...
		<ul>
			...
			<a href='professores.php'><li id='MarcadoItem'><i class='fas fa-user-tie'></i> Professores</li></a>
	...
	<a href="ajuda.php#Professores"><div id="btnhelp" title="Ajuda"><i class="fas fa-question"></i></div></a>
		...
		<section class="telas" style="height: 230px;">
			...
			<section class="selectI">
				<form action="javascript: void(0)">
					...
					<div>
						<input type="submit" value="Deletar Professor" onclick="excluirProfessor()">
					<div>
	...
	<section id="principal">
		...
		<div class="ferramentas">
			...
			<div><input type="text" placeholder="Pesquisar professor..." id="pesquisaInput" onchange="pesquisaProfessor()"><button><i class='fas fa-search'></i></button></div>

			<main>
				<button id="relatorio" onclick="abreMoldalRelatorio()">Emitir Relatório <i class='fas fa-file'></i></button>
				<a href="cadProfessor.php"><button id="cadastro">Cadastrar Professor <i class='fas fa-user'></i></button></a>
